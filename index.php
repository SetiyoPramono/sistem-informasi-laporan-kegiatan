                            ...
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    <div class="form-body">
                                        ...
                                        <br><center><p>Management Laporan</p></center>
                                        ...
                                        <form class="row g-3" method="POST" action="" enctype="multipart/form-data">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="input-group" id="show_hide_password">
                                                    <input type="password" name="pass" class="form-control border-end-0" id="inputChoosePassword" value="1234" placeholder="Enter Password"> <a href="javascript:;" class="input-group-text bg-transparent"><i class='bx bx-hide'></i></a>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="d-grid">
